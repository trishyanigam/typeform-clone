    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/40 backdrop-blur-xs animate-fade-in">
      ...
      >
        <div className="flex items-center justify-between pb-3 border-b border-zinc-100">
          <h2 className="text-base font-extrabold text-[#262627] tracking-tight">Create a new form</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4">
          <div>
            <label htmlFor="form-title" className="block text-xs font-bold text-zinc-700 uppercase tracking-wider mb-1.5">
              Form Title
            </label>
            <input
              id="form-title"
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-zinc-200 bg-zinc-50 text-zinc-900 text-xs focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:bg-white transition-all placeholder:text-zinc-400"
              autoFocus
              disabled={loading}
            />
